...
## 📖 About the Project
Shield AI is a mobile application designed to verify messages and predominantly the links within them to prevent phishing attacks. Developed as a Hackathon MVP, it provides an accessible, real-time layer of security against SMS scams, social engineering, and malicious URLs. 
...
* **Typosquatting & Contextual Detection:** Capable of catching deceptive links hidden inside seemingly harmless messages. For example, it can identify a malicious `https:discorcl.com/minecraft` link embedded within a long, friendly Minecraft community invite, protecting users from falling for the `discorcl.com` vs `discord.com` trick.
...
1. Clone the repository:
   ```bash
   git clone [https://github.com/Reorad/ShieldAi.git](https://github.com/Reorad/ShieldAi.git)
